...
public class SilentEXP extends Module {
    ...
    public SilentEXP() {
        super("SilentEXP", "Dont forget to punch a tree to get wood!", Category.COMBAT, true, false, false);
    }
    ...
    public final Setting<Bind> xpBind = this.register(new Setting("EXP Bind", new Bind(-1)));
