...
public class ClickGui extends Module
{
    ...
    public ClickGui() {
        ...
        this.red = (Setting<Integer>)this.register(new Setting("Red", 255, 0, 255, v -> this.setting.getValue() == Settings.Gui));
        this.green = (Setting<Integer>)this.register(new Setting("Green", 30, 0, 255, v -> this.setting.getValue() == Settings.Gui));
        this.blue = (Setting<Integer>)this.register(new Setting("Blue", 80, 0, 255, v -> this.setting.getValue() == Settings.Gui));
        this.hoverAlpha = (Setting<Integer>)this.register(new Setting("Alpha", 180, 0, 255, v -> this.setting.getValue() == Settings.Gui));
        this.alphaBox = (Setting<Integer>)this.register(new Setting("AlphaBox", 150, 0, 255, v -> this.setting.getValue() == Settings.Gui));
        this.alpha = (Setting<Integer>)this.register(new Setting("HoverAlpha", 240, 0, 255, v -> this.setting.getValue() == Settings.Gui));
        this.rainbow = (Setting<Boolean>)this.register(new Setting("Rainbow", true, v -> this.setting.getValue() == Settings.Gui));
        ...
        this.rainbowg = (Setting<Boolean>)this.register(new Setting("Rainbow", true, v -> this.setting.getValue() == Settings.Gradient));
        this.guiComponent = (Setting<Boolean>)this.register(new Setting("Gui Component", true, v -> this.setting.getValue() == Settings.Gradient));
