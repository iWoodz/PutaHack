...
public class HUD extends Module {
    ...
    public final Setting<Boolean> flowing = this.register(new Setting("Flowing", true));
    ...
    public Setting<String> command = register(new Setting("Command", "PutaHack.nn"));
    ...
    public Setting<Integer> animationHorizontalTime = register(new Setting("AnimationHTime", Integer.valueOf(500), Integer.valueOf(1), Integer.valueOf(1000), v -> this.arrayList.getValue()));
    public Setting<Integer> animationVerticalTime = register(new Setting("AnimationVTime", Integer.valueOf(50), Integer.valueOf(1), Integer.valueOf(500), v -> this.arrayList.getValue()));
    public Setting<RenderingMode> renderingMode = register(new Setting("Ordering", RenderingMode.ABC));
    public Setting<Integer> waterMarkY = register(new Setting("WatermarkPosY", Integer.valueOf(2), Integer.valueOf(0), Integer.valueOf(20), v -> this.waterMark.getValue()));
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        if (this.waterMark.getValue()) {
            String string = this.command.getPlannedValue() + " v0.1.3";
        ...
        if (this.arrayList.getValue())
            if (this.renderingUp.getValue()) {
                if (this.renderingMode.getValue() == RenderingMode.ABC) {
                    for (int k = 0; k < PutaHacknn.moduleManager.sortedModulesABC.size(); k++) {
                        String str = PutaHacknn.moduleManager.sortedModulesABC.get(k);
                        this.renderer.drawString(str, (width - 2 - this.renderer.getStringWidth(str)), (2 + j * 10), (ClickGui.getInstance()).rainbow.getValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue()).getRGB()) : flowing.getValue() ? ColorUtil.staticRainbow((j + 1) * 0.89f, color1) : this.color, true);
                        j++;
                ...
                for (int k = 0; k < PutaHacknn.moduleManager.sortedModulesABC.size(); k++) {
                    String str = PutaHacknn.moduleManager.sortedModulesABC.get(k);
                    j += 10;
                    this.renderer.drawString(str, (width - 2 - this.renderer.getStringWidth(str)), (height - j), (ClickGui.getInstance()).rainbow.getValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue()).getRGB()) : flowing.getValue() ? ColorUtil.staticRainbow((j + 1) * 0.89f, color1) : this.color, true);
                    counter1[0] = counter1[0] + 1;
                }
            } else {
                for (int k = 0; k < PutaHacknn.moduleManager.sortedModules.size(); k++) {
        ...
        if (this.renderingUp.getValue()) {
            if (this.potions.getValue()) {
                ...
                for (PotionEffect potionEffect : effects) {
                    String str = PutaHacknn.potionManager.getColoredPotionString(potionEffect);
                    i += 10;
            ...
            if (this.speed.getValue()) {
                ...
                i += 10;
                this.renderer.drawString(str, (width - this.renderer.getStringWidth(str) - 2), (height - 2 - i), (ClickGui.getInstance()).rainbow.getValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue()).getRGB()) : flowing.getValue() ? ColorUtil.staticRainbow((j + 1) * 0.89f, color1) : this.color, true);
                counter1[0] = counter1[0] + 1;
            }
            ...
            if (this.renderer.getStringWidth(str1) > this.renderer.getStringWidth(fpsText)) {
                if (this.ping.getValue()) {
                    i += 10;
                    this.renderer.drawString(str1, (width - this.renderer.getStringWidth(str1) - 2), (height - 2 - i), (ClickGui.getInstance()).rainbow.getValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue()).getRGB()) : flowing.getValue() ? ColorUtil.staticRainbow((j + 1) * 0.89f, color1) : this.color, true);
                    counter1[0] = counter1[0] + 1;
                }
                if (this.fps.getValue()) {
                    i += 10;
                    this.renderer.drawString(fpsText, (width - this.renderer.getStringWidth(fpsText) - 2), (height - 2 - i), (ClickGui.getInstance()).rainbow.getValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue()).getRGB()) : flowing.getValue() ? ColorUtil.staticRainbow((j + 1) * 0.89f, color1) : this.color, true);
                    counter1[0] = counter1[0] + 1;
                }
            } else {
                if (this.fps.getValue()) {
            ...
            if (this.speed.getValue()) {
                String str = grayString + "Speed " + ChatFormatting.WHITE + PutaHacknn.speedManager.getSpeedKpH() + " km/h";
                this.renderer.drawString(str, (width - this.renderer.getStringWidth(str) - 2), (2 + i++ * 10), (ClickGui.getInstance()).rainbow.getValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue()).getRGB()) : flowing.getValue() ? ColorUtil.staticRainbow((j + 1) * 0.89f, color1) : this.color, true);
                counter1[0] = counter1[0] + 1;
            }
            if (this.time.getValue()) {
                String str = grayString + "Time " + ChatFormatting.WHITE + (new SimpleDateFormat("h:mm a")).format(new Date());
        ...
        String direction = this.direction.getValue() ? PutaHacknn.rotationManager.getDirection4D(false) : "";
    ...
    public void renderLag() {
        ...
        if (PutaHacknn.serverManager.isServerNotResponding()) {
            String text = ChatFormatting.RED + "Server not responding " + MathUtil.round((float) PutaHacknn.serverManager.serverRespondingTime() / 1000.0F, 1) + "s.";
