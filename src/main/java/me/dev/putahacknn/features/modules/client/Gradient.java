...
public class Gradient
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        if (Util.mc.currentScreen instanceof PutaHacknnGui && this.cgui.getValue().booleanValue() || this.always.getValue().booleanValue() || this.gui.getValue().booleanValue() && Util.mc.currentScreen instanceof PutaHacknnGui) {
