...
public class MyCode
    ...
    public MyCode() {
        super("MyCode", "you fucking skidder i hope your family burns and dies in a horrific crash holy shit you are an absolute incel and mindless peice of shit", Module.Category.CLIENT, true, false, false);
    }
