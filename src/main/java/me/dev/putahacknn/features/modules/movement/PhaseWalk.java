...
import me.dev.putahacknn.util.PlayerUtill;
...
public class PhaseWalk
    ...
    public void onUpdate() {
        ...
        if (this.phaseCheck.getValue().booleanValue()) {
            if ((PhaseWalk.mc.gameSettings.keyBindForward.isKeyDown() || PhaseWalk.mc.gameSettings.keyBindRight.isKeyDown() || PhaseWalk.mc.gameSettings.keyBindLeft.isKeyDown() || PhaseWalk.mc.gameSettings.keyBindBack.isKeyDown() || PhaseWalk.mc.gameSettings.keyBindSneak.isKeyDown()) && (!this.eChestCheck() && !PhaseWalk.mc.world.getBlockState(PlayerUtill.getPlayerPos()).getBlock().equals((Object) Blocks.AIR) || !PhaseWalk.mc.world.getBlockState(PlayerUtill.getPlayerPos().up()).getBlock().equals((Object)Blocks.AIR))) {
                double[] speed;
