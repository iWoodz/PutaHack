...
public class Burrow
    ...
    Vec3d posCheck = null;
    public final Setting<Boolean> noToggle = this.register(new Setting<>("Auto", false));
    ...
    public final Setting<Boolean> center;
    ...
    public Burrow() {
        super("Burrow", "Rubberbands you into a block.", Module.Category.COMBAT, true, false, false);
        this.delay = this.register(new Setting<>("Wait", 3, 1, 20, this::new0));
        this.bypass = this.register(new Setting<>("Bypass", true));
        this.timer = new Timer();
        this.breakCrystal = this.register(new Setting<>("BreakCrystal", true));
        this.onlyOnGround = this.register(new Setting<>("OnlyOnGround", true));
        ...
        this.fast = this.register(new Setting<>("Fast", true));
        this.setInstance();
    }
    ...
    public void onTick() {
        ...
        if (InventoryUtil.getItemHotbar(Item.getItemFromBlock(Blocks.OBSIDIAN)) == -1 && InventoryUtil.getItemHotbar(Item.getItemFromBlock(Blocks.ENDER_CHEST)) == -1) {
            Command.sendMessage(ChatFormatting.RED + "ur out of obby retard");
            this.disable();
            return;
        }
