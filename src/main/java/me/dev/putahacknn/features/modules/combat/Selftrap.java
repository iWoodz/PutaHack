...
public class Selftrap
    ...
    private final me.dev.putahacknn.util.Timer offTimer = new me.dev.putahacknn.util.Timer();
    private final me.dev.putahacknn.util.Timer timer = new me.dev.putahacknn.util.Timer();
    private final Map<BlockPos, Integer> retries = new HashMap<BlockPos, Integer>();
    private final me.dev.putahacknn.util.Timer retryTimer = new Timer();
