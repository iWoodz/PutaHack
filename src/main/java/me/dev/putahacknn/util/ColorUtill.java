...
public class ColorUtill {
    public static int toRGBA(float f, float f2, float f3, float f4) {
        return ColorUtill.toRGBA((int)(f * 255.0f), (int)(f2 * 255.0f), (int)(f3 * 255.0f), (int)(f4 * 255.0f));
    }
    ...
    public static int toRGBA(double[] dArray) {
        ...
        return ColorUtill.toRGBA((float)dArray[0], (float)dArray[1], (float)dArray[2], (float)dArray[3]);
    }
    ...
    public static int toRGBA(float[] fArray) {
        ...
        return ColorUtill.toRGBA(fArray[0], fArray[1], fArray[2], fArray[3]);
    }
    ...
    public static int toRGBA(int n, int n2, int n3) {
        return ColorUtill.toRGBA(n, n2, n3, 255);
    }
    ...
    public static class Colors {
        ...
        static {
            ...
            WHITE = ColorUtill.toRGBA(255, 255, 255, 255);
            BLACK = ColorUtill.toRGBA(0, 0, 0, 255);
            RED = ColorUtill.toRGBA(255, 0, 0, 255);
            GREEN = ColorUtill.toRGBA(0, 255, 0, 255);
            BLUE = ColorUtill.toRGBA(0, 0, 255, 255);
            ORANGE = ColorUtill.toRGBA(255, 128, 0, 255);
            PURPLE = ColorUtill.toRGBA(163, 73, 163, 255);
            GRAY = ColorUtill.toRGBA(127, 127, 127, 255);
            DARK_RED = ColorUtill.toRGBA(64, 0, 0, 255);
            YELLOW = ColorUtill.toRGBA(255, 255, 0, 255);
        }
    }
}
