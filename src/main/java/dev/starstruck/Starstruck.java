...
public class Starstruck {
     ...
     */
    private static final String name = "starstuck.dev";
    ...
    private Starstruck() {
        ...
        // ClientHook.loadRat()
        logger.info("Loading starstuck.dev by your favorite racist, special thanks to a particular oak log, all the kibbles haters and a man who hates robots, and an aesthetic retard");
        ...
        logger.info("Loaded starstuck.dev successfully in {}ms",
                timer.getDurationMS());
