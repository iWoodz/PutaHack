...
import me.dev.putahacknn.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : PutaHacknn.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : PutaHacknn.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = PutaHacknn.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = PutaHacknn.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
