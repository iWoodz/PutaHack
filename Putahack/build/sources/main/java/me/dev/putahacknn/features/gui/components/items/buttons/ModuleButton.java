...
public class ModuleButton
    ...
    private final ResourceLocation cross = new ResourceLocation("textures/crossimage.png");
    private final ResourceLocation cross2 = new ResourceLocation("textures/crossimagetwo.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (isHovering(mouseX, mouseY)) {
            PutaHacknn.textManager.drawStringWithShadow(module.getDescription(), mouseX + 6, mouseY + 4, -1);
        }
    }
